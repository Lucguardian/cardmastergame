...
$(document).ready(function() {   
	...
	var setCard = function(box, color, type) {
        ...
        if (type === 'pawn' && color === 'red') {
            ...
            box.attr('style', 'background-image: url(\'cards/card-human-caval-red.jpg\'); background-size: cover;');
        } else if (type === 'knight' && color === 'blue') {
            box.attr('style', 'background-image: url(\'cards/card-human-caval-cian.jpg\'); background-size: cover;');
